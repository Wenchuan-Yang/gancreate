...
if __name__ == '__main__':
    ...
    # parser.add_argument('--repo', type=str, required=True,default= '~/stylegan2 checkpoint/stylegan2.pkl')
    parser.add_argument('--gen', action='store_true')
    parser.add_argument('--disc', action='store_true')
    parser.add_argument('--channel_multiplier', type=int, default=2)
    # parser.add_argument('path', metavar='PATH',default= '~/stylegan2 checkpoint/stylegan2.pkl')
    ...
    path_ = "/home/mayuan/gan/gancreate-saai-main/models/stylegan2/checkpoint/stylegan2.pkl"
    ...
    outpath = Path(root) / f"checkpoint/1.pt"
