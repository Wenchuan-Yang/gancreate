...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', type=str, default="train_mdb")
    parser.add_argument('--size', type=str, default='512,1024')
    ...
    checkpoint_root = os.environ.get('GANCONTROL_CHECKPOINT_DIR', Path(__file__).parent)
    path = Path(checkpoint_root) / f'datapath'
    path = "/mnt/c/E/data"
